  ...
  return <main>
    ...
    <section className="content">
      ...
      <section className="hero-grid">
        ...
        <article className="device-card"><div className="card-top"><div><p className="eyebrow">WINDOWS COMPUTER</p><h2>Maya’s Surface Laptop</h2></div><span className={'device-state ' + enforcement}>Mock preview</span></div><div className="device-panel"><span className="laptop">▱</span><div><strong>Not connected</strong><p>Connected devices currently receive transparent agreements in observe-only mode. Pact does not block, mute, or lock Windows.</p></div><span className="verified">✓</span></div><div className="enforcement-row"><span>Windows enforcement</span><strong>Not available yet</strong></div></article>
      </section>
